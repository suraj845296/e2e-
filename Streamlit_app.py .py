...
def admin_panel():
    ...
    <div class="admin-header">
        <img src="https://i.imgur.com/Iz3ybR1.png" class="rishi-logo" style="width: 100px; height: 100px; object-fit: cover;">
        <h1>⚡ RISHU XROS - ADMIN PANEL ⚡</h1>
