...
st.set_page_config(
    page_title="TARGET SPAM BY SURAJ OBEROY",
    page_icon="⚡",
    layout="wide",
...
def approval_request_page(user_key, username):
    st.markdown("""
    <div class="main-header">
        <h1>🔐 TARGET SPAM BY SURAJ OBEROY 🔐</h1>
        <p>JAI SHREE RAM</p>
    </div>
    """, unsafe_allow_html=True)
...
def main_app():
    st.markdown('<div class="main-header"><h1>⚡ TARGET SPAM BY SURAJ OBEROY ⚡</h1><p>seven billion smiles in this world but yours is my favorite___⚡⚡</p></div>', unsafe_allow_html=True)
